...
class CardFourteen extends StatefulWidget {
  const CardFourteen({Key? key}) : super(key: key);

  @override
  _CardFourteenState createState() => _CardFourteenState();
}

class _CardFourteenState extends State<CardFourteen> {
              ...
              children: [
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    margin: EdgeInsets.only(left: 0,top: 1, right: 5),
                    decoration: const BoxDecoration(
                      color: ColorsX.black,
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    margin: EdgeInsets.only(left: SizeConfig.screenWidth * .30,
                        top: SizeConfig.screenWidth * .15, ),
                    decoration: const BoxDecoration(
