...
class CardThirteen extends StatefulWidget {
  const CardThirteen({Key? key}) : super(key: key);

  @override
  _CardThirteenState createState() => _CardThirteenState();
}

class _CardThirteenState extends State<CardThirteen> {
              ...
              children: [
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                      color: ColorsX.blue_gradient_pure_dark,
