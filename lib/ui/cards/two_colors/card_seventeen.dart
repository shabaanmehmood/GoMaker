...
class CardSeventeen extends StatefulWidget {
  const CardSeventeen({Key? key}) : super(key: key);

  @override
  _CardSeventeenState createState() => _CardSeventeenState();
}

class _CardSeventeenState extends State<CardSeventeen> {
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            ...
                            colors: [
                              ColorsX.dotssliderColor,
                              ColorsX.dashboardHome,
                              ColorsX.calender_pink,
                            ],
                          ),
                        ),
                      ),
  ...
  backButton(BuildContext context){
    return GestureDetector(
      onTap: (){
        Get.toNamed(Routes.CARD_ELEVEN);
      },
      child: Container(
