...
class CardTen extends StatefulWidget {
  const CardTen({Key? key}) : super(key: key);

  @override
  _CardTenState createState() => _CardTenState();
}

class _CardTenState extends State<CardTen> {
